...
# ---------- Output Path ----------
output_dir_input = input(f"{Colors.HEADER}Enter output folder path (or press Enter for default {DEFAULT_OUTPUT_DIR}): {Colors.ENDC}").strip()
output_dir = Path(output_dir_input) if output_dir_input else Path(DEFAULT_OUTPUT_DIR)
